...
stdenv.mkDerivation (
  ...
  // {
    ...
    # https://github.com/StellarWitch7/element-desktop/blob/develop/package.json
    ...
    meta = with lib; {
      ...
      changelog = "https://github.com/StellarWitch7/element-desktop/blob/v${finalAttrs.version}/CHANGELOG.md";
